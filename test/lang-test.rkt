#lang reader streamline/lang/reader

import
"interfaces/ERC721.sol" ;
...
0
mfn
mapAzukiOwnerChanges
=
[storeAzukiOwners.deltas]
|> map (delta) => do{
       foo = foo + 1;
       {
        delta: delta,
