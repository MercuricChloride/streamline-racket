...
(require streamline/lang/classes
         ...
         (for-syntax streamline/lang/configure-runtime syntax/parse)
         streamline/lang/runtime-helpers
         syntax/strip-context)

(provide (rename-out (streamline:read-syntax read-syntax) (streamline:read read))
...
(define (streamline:read-syntax path input)
  ...
  (with-syntax ([path path] [(node ...) (map transform (syntax->list ast))])
